  ...
  return (
    <section>
      <div className="relative">
        ...
        <h1 className="fontChronicle w-[400px] absolute md:top-2/4 top-1/4 md:left-10 left-[16%] text-5xl text-blue-700">The meal kit that puts quality first</h1>
        <button onClick={() => navigate('/market')} className="fontCera absolute md:top-2/3 top-[40%] md:left-10 left-[30%] mt-5 rounded-3xl	h-[50px] w-[180px] bg-blue-700 text-white tracking-widest">
          SEE PLANS
        </button>
      </div>
      <div className="rating-section flex flex-col items-center justify-center bg-coolGray-200 h-[250px] gap-2 fontCera">
        ...
        <button onClick={() => navigate('/users/sign_in?redirect=/pricing')} className="rounded-3xl	h-[50px] w-[180px] font-medium bg-blue-700 text-white tracking-widest mt-3">
          SEE PLANS
        </button>
      </div>
    </section>

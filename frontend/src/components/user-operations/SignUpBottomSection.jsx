import papers from '../../assets/icons/foodCard.png';
import calendarCheck from '../../assets/icons/foodCard.png';
import box from '../../assets/icons/foodCard.png';
      ...
      <ul className="flex flex-row m-auto w-[50%] min-[515px]:gap-[26px] gap-4 mb-[28px] mt-10 justify-center">
        <li className="w-[280px] border border-[#E3E6ED] rounded-[4px] px-[25px] text-center text-[#6a6d75]">
          <div className="relative">
            ...
            <p className="text-[14px] leading-[1.5] fontCera">Receive your delivery whenever it is convenient, and skipping or canceling is easy.</p>
          </div>
        </li>
        <li className="w-[280px] border border-[#E3E6ED] rounded-[4px] px-[25px] text-center text-[#6a6d75]">
          <div className="relative">
            ...
            <p className="text-[14px] leading-[1.5] fontCera">Select from our Signature or Signature for 4 plans. Tell us your dietary preferences and we will personalize the menus you receive.</p>
          </div>
        </li>
        <li className="w-[280px] border border-[#E3E6ED] rounded-[4px] px-[25px] text-center text-[#6a6d75]">
          <div className="relative">
            ...
            <p className="text-[14px] leading-[1.5] fontCera">Ingredients are carefully packaged in a refrigerated box so food stays fresh even if you are not home when we deliver.</p>
          </div>
        </li>
      </ul>
    </section>

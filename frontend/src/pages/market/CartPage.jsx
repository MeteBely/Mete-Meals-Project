...
const CartPage = () => {
  ...
  //Proceed To Checkout butonuna basıldığında shipping page'ye yönlendirilir(adres). Giriş yapılmamışsa önce login'e yönlendirilir. Daha sonra redirect olur.
  ...
  return (
    <div className="mt-20 mb-4">
      {cartItems.length === 0 ? (
        ...
        <div className="flex flex-wrap flex-row justify-evenly items-start">
          ...
          <div className="card h-auto pb-4 w-[350px] fontCera">
